...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { 
    term: '套边配合 (Overlap)', 
    definition: '边后卫从控球的队友（通常是边锋）身后或身侧高速插上，从而在局部形成以多打少的态势。', 
    category: 'Action',
    icon: '🏃',
    visualEffect: 'overlap',
    complexity: 3,
    strategicFocus: ['局部超编', '边路深度', '传中机会'],
    keyTraits: ['插上意识', '速度衔接', '传中精准度'],
    famousTeams: ['利物浦 (阿诺德/罗伯逊时期)', '拜仁慕尼黑 (拉姆时期)'],
    radarProfile: [
      { subject: '控球', A: 70, fullMark: 100 },
      { subject: '压迫', A: 75, fullMark: 100 },
      { subject: '速度', A: 95, fullMark: 100 },
      { subject: '创造力', A: 80, fullMark: 100 },
      { subject: '防守', A: 60, fullMark: 100 },
      { subject: '纪律', A: 85, fullMark: 100 },
    ]
  },
  { 
    ...
    definition: '位于球场中路与边路之间的纵向走廊。现代战术中，这里被认为是撕开对手防线最高效的区域。', 
    category: 'Phase',
    icon: '📏',
    visualEffect: 'half-space',
    complexity: 4,
    strategicFocus: ['结构性优势', '盲区接球', '对角线进攻'],
    keyTraits: ['空间阅读', '局部配合', '威胁球穿透'],
    famousTeams: ['曼城 (德布劳内/大卫·席尔瓦时期)'],
    radarProfile: [
      { subject: '控球', A: 85, fullMark: 100 },
      { subject: '压迫', A: 70, fullMark: 100 },
      { subject: '速度', A: 65, fullMark: 100 },
      { subject: '创造力', A: 100, fullMark: 100 },
      { subject: '防守', A: 50, fullMark: 100 },
      { subject: '纪律', A: 90, fullMark: 100 },
    ]
  }
];
